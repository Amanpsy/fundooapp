...
setRegexobj((prevState) => ({...prevState, passwordBorder:true, passwordHelper:"Enter valid passsword"}))
}
...
<img src="../GoogleLogo.png" alt="Google"></img>
    ...
    label="Email ID"  size="small" required onChange={takeEmail} error={regexObj.emailBorder} helperText={regexObj.emailHelper}
	/>
    <TextField type="password" 
    sx={{ marginTop:4 , width: 0.92 }} 
    InputLabelProps={{style: {fontSize: 13}}}
    label="Password"  size="small" required onChange={takePassword} error={regexObj.passwordBorder} helperText={regexObj.passwordHelper}
	/>
        ...
        <Button variant="text"size="small" onClick={loginSucessful} >Sign In </Button>
